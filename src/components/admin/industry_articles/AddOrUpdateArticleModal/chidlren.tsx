...
import { Box, Button, Input, LoadingOverlay, TextInput } from '@mantine/core';
        ...
        <formApi.Field
          ...
          children={({ name, state, handleChange, handleBlur }) => (
            <TextInput
              ...
              rightSectionPointerEvents="auto"
              placeholder="合规是企业的立身之本，只有依法合规经营，企业才能行稳致远。依法诚信纳税是企业合规的一个重要方面，随着税收营商环境不断优化、税收法治深入人心，越来越多的企业意识到依法诚信纳税是企业做大做强、实现高质量发展的重要保障。"
